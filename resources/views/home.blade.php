...
@section('container')
        ...
        <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="hero-img carousel-item active">
              <img class="text-end img-fluid" src="img/himatik.png" class="d-block" alt="..." width="100%">
            </div>
            <div class="hero-img carousel-item">
              <img class="text-end img-fluid" src="img/hero-illustration.png" class="d-block" alt="..." width="100%">
            </div>
          </div>
        </div>
      </div>
  ...
  <section id="officials" class="mt-100">
    <div class="container">
      <div class="row mb-4">
        ...
        @foreach ($officials->only([1, 2, 3, 4]) as $official)
          <div class="col" data-aos="fade-up" data-aos-duration="1000">
            <div class="official-cards card rounded-3 text-center">
              <img class="img-fluid" src="img/avatar.png" class="card-img-top" alt="{{ $official->nama }}">
              <div class="card-body">
  ...
  <section id="departments" class="mt-100">
    <div class="container">
      <div class="row mb-4">
        <div class="col-12 text-center" data-aos="fade-up">
  ...
  <section id="tell-us" class="tell-us mt-100">
      ...
      <div class="row py-5 text-center justify-content-center align-items-center">
        <div class="col-sm-6">
          ...
          <div class="input-group mt-3 shadow rounded-10" data-aos="fade-up" data-aos-duration="1000">
            ...
            <button class="btn btn-primary btn-cta" type="button" id="button-addon2">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Tentang HIMATIK</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quo quod, amet distinctio libero blanditiis recusandae sunt optio, explicabo quasi debitis consequatur cumque animi sed!
          </p>
        </div>
      </div>
    </div>
