                    ...
                    <div class="card-body">
                        ...
                        <div class="text-end">
                            <button type="button"
                                    ...
                                    data-bs-target="#modalEdit{{ $official->id }}">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title"
                                id="exampleModalLabel">Edit Struktur Kepengurusan</h5>
                            <button type="button"
                                    class="btn-close"
                                    data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                        </div>
                        <form action="/dashboard/officials/{{ $official->id }}"
                              method="post"
